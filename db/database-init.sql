...
Insert into PERSON (ID_PERSON,FIRSTNAME,LASTNAME,STREET,CITY,PSC,EMAIL) values (PERSON_SEQ.nextval,'Aneta','Nováová','street','city','psc','email');   --5
...
Insert into PERSON (ID_PERSON,FIRSTNAME,LASTNAME,STREET,CITY,PSC,EMAIL) values (PERSON_SEQ.nextval,'Monika','Nováková','street','city','psc','email');      --7
